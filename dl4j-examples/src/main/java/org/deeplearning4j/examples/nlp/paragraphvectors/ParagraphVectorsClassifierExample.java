...
public class ParagraphVectorsClassifierExample {
	...
	public static void main(String[] args) throws Exception {
		...
		ParagraphVectorsClassifierExample app = new ParagraphVectorsClassifierExample();//又是这种写法，构建实现类    
	...
	void makeParagraphVectors() throws Exception {
		ClassPathResource resource = new ClassPathResource("paravec/labeled");//弄一个带标签的文档路径    
		...
		paragraphVectors = new ParagraphVectors.Builder().learningRate(0.025).minLearningRate(0.001).batchSize(1000)
				.epochs(2).iterate(iterator).trainWordVectors(true).tokenizerFactory(tokenizerFactory).build();
